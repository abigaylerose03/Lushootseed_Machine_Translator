...
# test_phrase = "yo my name is abby"
# decoded_sentence = decode_sequence(test_phrase)
# print(decoded_sentence)


with open("Data_please_work.txt", "a") as f:
  new_text = input("Please enter an English sentence you want translated:")
  f.write("\n" + new_text + ".\t")
  f.close()# new_text = input("Please enter an English sentence you want translated:")
  # f.write("\n" + new_text + "." + "\t" + "\n")

# file = open("Data_please_work.txt", "r")
# print(file.read())
# print("Done.\n")
